...
#define		STREAM_MODE_STA_NUM		4
    ...
    UINT    StrictRegulationForKR;
    UINT    EFM_LedMode;
#define MAX_OVERRIDING_EEPROM 128
    CHAR    OverridingEEPROM[MAX_OVERRIDING_EEPROM];
...
/*****************************************************************************************/
	...
	CHANNEL_TX_POWER ChannelList_BackUp[MAX_NUM_OF_CHANNELS];
