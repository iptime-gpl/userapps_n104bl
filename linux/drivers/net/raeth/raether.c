...
#ifdef CONFIG_EFM_PATCH_IPTV_MOD
...
void setup_internal_gsw(void)
{
	...
	*(volatile u_long *)(RALINK_SYSCTL_BASE + 0x60) &= ~(0x1 << 15);
	...
	//GMAC2= RGMII mode
	*(volatile u_long *)(SYSCFG1) &= ~(0x3 << 14);
#ifndef CONFIG_EFM_PATCH_IPTV_MOD
...
#endif
#endif // CONFIG_EFM_PATCH_IPTV_MOD

#if defined (CONFIG_RAETH_8023AZ_EEE) || defined(CONFIG_EFM_PATCH_IPTV_MOD)
